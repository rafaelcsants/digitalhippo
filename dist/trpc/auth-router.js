...
exports.authRouter = (0, trpc_1.router)({
    createPayloadUser: trpc_1.publicProcedure
        ...
        .mutation(function (input) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, email, password, payload, users;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = input.input, email = _a.email, password = _a.password;
