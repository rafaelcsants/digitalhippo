...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var webwookMiddleware, payload, cartRouter;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                webwookMiddleware = body_parser_1.default.json({
            ...
            case 1:
                ...
                //-----------------------------------------------------------------------------------
                app.post("/api/webhooks/stripe", webwookMiddleware, webhooks_1.stripeWebhookHandler);
